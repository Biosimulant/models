# Oliveira2020 - Beta-Alanine pathway for Acrylic Acid production from glucose

**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL2010040001)
**Standard**: sbml
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/sbml-oliveira2020-beta-alanine-pathway-for-acrylic-acid/model.yaml
```
