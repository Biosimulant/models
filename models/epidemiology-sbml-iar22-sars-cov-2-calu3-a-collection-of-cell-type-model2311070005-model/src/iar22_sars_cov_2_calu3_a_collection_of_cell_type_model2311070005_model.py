...
"""Auto-generated SBML BioModule wrapper for iAR22_SARS-CoV-2_Calu3 - A collection of cell-type specific constraint-based metabolic models of human Calu-3 cells infected with SARS-CoV-2.

Source: biomodels_ebi:MODEL2311070005
Original: https://www.ebi.ac.uk/biomodels/MODEL2311070005
"""
...
class SbmlIar22SarsCov2Calu3ACollectionOfCellTypeSpecific(bsim.BioModule):
    """BioModule wrapper for SBML model: iAR22_SARS-CoV-2_Calu3 - A collection of cell-type specific constraint-based metabolic models of human Calu-3 cells infected with SARS-CoV-2."""

    def __init__(self, model_path: str = "data/model.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iar22SarsCov2Calu3ACollectionOfCellTypeModel2311070005Model = SbmlIar22SarsCov2Calu3ACollectionOfCellTypeSpecific
